...
const [authSuccess, setAuthSuccess] = useState('');
  ...
  const translations = {
    ...
    Amharic: {
      ...
      testimonial1: "በከተማው ውስጥ ከሚገኙት ሁሉ ጥሩው ፋስት ፉድ! በርገሮቻቸው አስደናቂ ነው።",
    ...
    Tigrigha: {
      ...
      addToCart: "ናብ ጋሪ ወስኹ",
      home: "ቤት",
      watchFeedback: "ከመይ ጌርና ንኣገልግሎትና ዓማዊልና ከመይ ከም ዘሐጉሱ ርአዩ",
      betterTaste: "መግብና ቅመሱ እሞ ፍርያትና ክንደይ ጥዑም ምዃኑ ፈልጡ!",
      testimonial1: "ኣብታ ኸተማ ዘሎ ዝበለጸ ፋስት ፉድ! በርገሮም ኣዝዮም ጽቡቕ እዮ።",
      testimonial2: "ቅልጡፍ እዩ እሞ ኣዝዩ ጽቡቕ ናይ ዓማዊል ኣገልግሎት",
